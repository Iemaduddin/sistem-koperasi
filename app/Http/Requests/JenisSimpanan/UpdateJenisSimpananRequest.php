...
class UpdateJenisSimpananRequest extends FormRequest
{
    ...
    {
        $jenisSimpanan = $this->route('jenis_simpanan');
        $jenisSimpananId = $jenisSimpanan instanceof JenisSimpanan
            ? $jenisSimpanan->getKey()
            : $jenisSimpanan;
        ...
        return [
            ...
            'kode' => [
                ...
                'string',
                'max:255',
                Rule::unique('jenis_simpanan', 'kode')->ignore($jenisSimpananId),
            ],
